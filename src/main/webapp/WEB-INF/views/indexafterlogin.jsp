                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mx-lg-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="${pageContext.request.contextPath}/loginCheck.controller">Home <span class="sr-only">(current)</span></a>
                        </li>
              ...
              <div class="theme-switch-wrapper">
                ...
                <div class="dropdown"> 
                   ...
                   <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      ...
                      <div class="out">
                        <a class="dropdown-item" href="<c:url value='/homeLoginPage'  />"/><i class="fas fa-door-open"></i> 登出</a>
                      </div>
                    </div>
                </div> 
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 item">
                    <a href="assets/images/c1.jpg" data-lightbox="example-set" data-title="Project 1"
                        class="zoom d-block">
                ...
                <div class="col-lg-4 col-md-6 item mt-md-0 mt-4">
                    <a href="assets/images/c2.jpg" data-lightbox="example-set" data-title="Project 2"
                        class="zoom d-block">
                ...
                <div class="col-lg-4 col-md-6 item mt-lg-0 mt-4">
                    <a href="assets/images/c3.jpg" data-lightbox="example-set" data-title="Project 3"
                        class="zoom d-block">
                ...
                <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                    <a href="assets/images/c4.jpg" data-lightbox="example-set" data-title="Project 4"
                        class="zoom d-block">
                ...
                <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                    <a href="assets/images/c5.jpg" data-lightbox="example-set" data-title="Project 5"
                        class="zoom d-block">
