...
<body>
    ...
    <table class="tb1">
      ...
      <thead>
        <tr>
          <th><button type="button" class="btn btn-info">Work Out</button></th>
          <th><button type="button" class="btn btn-info">Strench</button></th>
          <th><button type="button" class="btn btn-info">ball</button></th>
          <th><button type="button" class="btn btn-info">格鬥</button></th>
          <th><button type="button" class="btn btn-info">短跑</button></th>
        </tr>

        <tr>
          <th><button type="button" class="btn btn-info">舞蹈</button></th>
          <th><button type="button" class="btn btn-info">馬術</button></th>
          <th><button type="button" class="btn btn-info">團隊</button></th>
          <th><button type="button" class="btn btn-info">競技體育</button></th>
          <th><button type="button" class="btn btn-info">電子競技</button></th>
        </tr>
      </thead>
  ...
  <div class="box1" style="margin-top: 150px;">
    ...
    <div class="box2">
      <img class="img1" src="<c:url value='/images/yoga.jpg' />"/>
     </div>
    <div class="box3">
      <h2>30 Day Yoga Challenge Learn Yoga Online</h2>
      <p>Beginner Yoga Lessons at Home or in Nature - Learn Yoga skills, Yoga Poses, Study Yoga Fundamentals for Beginners Yoga</p>
      <p>Chin Hwung 秦始皇</p>
  ...
  <div class="box1">
    ...
    <div class="box2">
      ...
      <img class="img1" src="<c:url value='/images/swim.jpg/'  />" />
    </div>
    <div class="box3">
      <h2>Total Immersion Swimming: Swim Better, Easier, Faster!</h2>
      <p>Official Course: Total Immersion head coach Terry Laughlin teaches you how to swim faster and further using less effort</p>
      <p>Chin Hwung 秦始皇</p>
      <span><img class="img2" src="<c:url value='/images/lilstar.png/' />"/>(353)</span>
      <p>total:72 hours </p>
      <span class="sp01"><button class="btnbuy">加入購物車</button></span>
  ...
  <div class="box1">
    ...
    <div class="box2">
      <img class="img1" src="<c:url value='/images/workout.jpg/' />"/>
    </div>

    <div class="box3">
      <h2>Home Workouts: 7 Day Bodyweight HIIT Workout Program</h2>
      <p>Anywhere, anytime workouts for busy professionals. Feel great in front of the mirror quicker and easier than before.</p>
      <p>Chin Hwung 秦始皇</p>
      <span><img class="img2" src="<c:url value='/images/lilstar.png/' />"/>(353)</span>
      <p>total:72 hours </p>
      <span class="sp01"><button class="btnbuy">加入購物車</button></span>
  ...
  <div class="box1">
    ...
    <div class="box2">
      <img class="img1" src="<c:url value='/images/tennis.jpg/'/>"/>
    </div>

    <div class="box3">
      <h2>Tennis 101: How to Play Tennis</h2>
      <p>Learn and Master the Fundamentals of Tennis with College Head Tennis Coach, Adrian Gonzales</p>
      <p>Chin Hwung 秦始皇</p>
      <span><img class="img2" src="<c:url value='/images/lilstar.png/'/>"/>(353)</span>
      <p>total:72 hours </p>
      <span class="sp01"><button class="btnbuy">加入購物車</button></span>
  ...
  <div class="box1">
    ...
    <div class="box2">
      <img class="img1" src="<c:url value='/images/basketball.jpg/'/>"/>
    </div>

    <div class="box3">
      <h2>Basketball for Beginners</h2>
      <p>Drills to help you improve every part of your game!</p>
      <p>Chin Hwung 秦始皇</p>
      <span><img class="img2" src="<c:url value='/images/lilstar.png/'/>"/>(353)</span>
      <p>total:72 hours </p>
      <span class="sp01"><button class="btnbuy">加入購物車</button></span>
  ...
  <div class="box1">
    ...
    <div class="box2">
      <img class="img1" src="<c:url value='/images/baseball.jpg/'/>"/>
    </div>

    <div class="box3">
      <h2>Baseball Hitting Drills</h2>
      <p>featuring Coach Ray Birmingham!</p>
      <p>Chin Hwung 秦始皇</p>
      <span><img class="img2" src="<c:url value='/images/lilstar.png/'/>"/>(353)</span>
      <p>total:72 hours </p>
      <span class="sp01"><button class="btnbuy">加入購物車</button></span>
